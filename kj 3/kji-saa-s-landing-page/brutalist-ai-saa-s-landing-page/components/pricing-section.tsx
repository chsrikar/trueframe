...
const TIERS: Tier[] = [
  {
    ...
    period: "%",
    tag: null,
    description: "Overall correct predictions across Genuine, AI-Generated, and Manipulated classes.",
    features: [
      { text: "CelebA-HQ (28,000 Genuine)", included: true },
      { text: "CASIA_AU (7,491 Genuine)", included: true },
      { text: "SFHQ-T2I (40,000 AI)", included: true },
      { text: "Test Samples: 11,324", included: true },
      { text: "WeightedRandomSampler", included: true },
      { text: "Hold-out Evaluation", included: true },
    ],
    cta: "VIEW MATRIX",
    highlighted: false,
  },
  {
    ...
    period: "%",
    tag: "MACRO-AVG",
    description: "Harmonic mean of precision and recall across all three classification categories.",
    features: [
      { text: "Macro F1 = 0.850", included: true },
      { text: "Balanced Precision", included: true },
      { text: "Balanced Recall", included: true },
      { text: "Weighted Sampling", included: true },
      { text: "CrossEntropy Loss", included: true },
      { text: "AdamW Optimizer", included: true },
    ],
    cta: "VIEW ROC-AUC",
    highlighted: true,
  },
  {
    ...
    period: "",
    tag: null,
    description: "Combining classifier confidence + metadata signal + forensic artifact signal.",
    features: [
      { text: "EfficientNet-B0 backbone", included: true },
      { text: "Grad-CAM explainability", included: true },
      { text: "EXIF & metadata extraction", included: true },
      { text: "ELA+ Frequency domain GAN fingerprints", included: true },
      { text: "Fusion Score (0-100)", included: true },
...
function PricingCard({ tier, index }: { tier: Tier; index: number }) {
  const isCustom = tier.price === "ACTIVE"
    ...
    >
      ...
      <div className="px-5 pt-6 pb-4">
        <div className="flex items-baseline gap-1">
          {isCustom ? (
            <span className="text-3xl lg:text-4xl font-mono font-bold tracking-tight">ACTIVE</span>
          ) : (
...
export function PricingSection() {
  return (
    <section className="w-full px-6 py-20 lg:px-12">
      ...
      >
        <div className="flex flex-col gap-3">
          ...
          <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed max-w-md">
            TRUEFRAME is rigorously evaluated on a held-out test set to ensure high precision and recall across all classes.
          </p>
        </div>
        <StatusLine />
      </motion.div>
      ...
      >
        <span className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground font-mono">
          {"* Metrics evaluated on a held-out test set."}
        </span>
        <div className="flex-1 border-t border-border" />
      </motion.div>
    </section>
